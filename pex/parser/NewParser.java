...
public class NewParser implements Serializable{
    ...
    public NewParser(Interpreter interp) {
        _interp = interp;
    }
    ...
    public Program parseFile(String fileName, String programName ) throws BadSourceException, BadNumberException, InvalidExpressionException, 
        ...
        _program = new Program(programName, _interp); 
    ...
    private Expression parseExpression() throws IOException, BadNumberException, InvalidExpressionException, MissingClosingParenthesisException,
        ...
        switch (token) {
            ...
            case StreamTokenizer.TT_WORD:
                return  new Identifier(_tokenizer.sval, _interp); /* may need aditional parameters */
    ...
    private CompositeExpression parseCompositeExpression() throws IOException, BadNumberException, UnknownOperationException, MissingClosingParenthesisException,
        ...
        switch (operatorName) {
            ...
            case "reads":
                return new ReadS(_interp); /* may need additional parameters */

            case "readi":
                return new ReadI(_interp); /* may need additional parameters */
            ...
            case "call":
                try {
                    return new Call((StringLiteral)parseArgument(), _interp); /* may need additional parameter */
            ...
            case "ge":
             ...
             case "set":
                 return new Set(parseArgument(), parseArgument(), _interp); /* may need additional parameters */
